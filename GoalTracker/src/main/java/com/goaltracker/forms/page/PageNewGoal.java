...
import com.goaltracker.goal.FocusGoal;
import com.goaltracker.goal.HabitGoal;
import com.goaltracker.goal.SkillGoal;
    ...
    private void createGoalButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_createGoalButtonMouseClicked
        ...
        if (goalType.equals("Binary")) {
            ...
            try {
                ...
                System.out.println ("Got Target Date: " + tDate);
