...
public class Constants {
    ...
    public static final String NOTES_LABEL_OPEN   = "▼  Notes";
    public static final String ACTIVITY_LABEL_CLOSED = "►  Activity";
    public static final String ACTIVITY_LABEL_OPEN   = "▼  Activity";
    public static final String TASKS_LABEL_CLOSED = "►  Tasks";
    public static final String TASKS_LABEL_OPEN   = "▼  Tasks";

    public static final Color APP_BGCOLOR = new Color(240,240,240);
    public static final Color MAIN_VIEW_BGCOLOR = new Color(240,250,240);
    ...
    public static final Color GOAL_BGCOLOR = new Color(240,240,240);
